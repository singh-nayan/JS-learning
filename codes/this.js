// the whole js code is in an object, be it global or user defined
...
function fullName(){
    ...
    return firstName+lastName;            // it will return global object key values   
     // return this.firstName+this.lastName;  // it will return global object key values
}
...
var person={
    ...
    fullName:function(){
        ...
        //return firstName+lastName;            // it will return overwritten values    
        return this.firstName+this.lastName     // it will return current object key values
